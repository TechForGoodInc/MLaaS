...
def app():
    ...
    img_file_buffer = st.file_uploader("Upload an image", type=[ "jpg", "jpeg",'png'])#,key = count)
    #count += 1
    ...
    if useText:
        ...
        text = st.text_input('',value = 'Making the world a beter place - one line of code at a time')
